...
namespace PictureExchangerAPI.Persistence
{
    public static class DataForDB
    {
        ...
        {
            new User() { Id = new Guid("35434031-0853-472c-8c87-3b7831e0fd17"), Name = "1", Email = "1@1.1", RoleId = Roles[0].Id, PasswordHash = "yE3UT3m6W4KlkNLJdTAM4UQYIZuS7QIU/6kWcAjU/mc=", PasswordSalt = new byte[] { 118 ,75 ,18 ,36 ,222 ,48 ,190 ,38 ,185 ,49 ,119 ,151 ,113 ,34 ,164 ,228 }, RegistrationDate = new DateTime(2023, 4, 6), IsBanned=false, BannedDate=null, RefreshTokens = new List<RefreshToken>() },
            new User() { Id = new Guid("f725550b-b2b0-4509-85bd-556535471756"), Name = "2", Email = "2@2.2", RoleId = Roles[0].Id, PasswordHash = "KjK/J9gOLsJ5Qi8MQlpn7+G5YcU1ZnQtuZI1X+TTzy0=", PasswordSalt = new byte[] { 137 ,110 ,127 ,108 ,129 ,137 ,155 ,42 ,178 ,110 ,230 ,77 ,29 ,222 ,131 ,149 }, RegistrationDate = new DateTime(2023, 5, 8), IsBanned=false, BannedDate=null, RefreshTokens = new List<RefreshToken>() },
            new User() { Id = new Guid("2efa388c-584b-4e8d-9c5d-29fa600cfac9"), Name = "3", Email = "3@3.3", RoleId = Roles[1].Id, PasswordHash = "mVJOzj048UABroLpqaiOCXC7ov4rY/bHqr8zYznk+2I=", PasswordSalt = new byte[] { 34 ,54 ,150 ,248 ,77 ,23 ,108 ,37 ,149 ,29 ,207 ,94 ,119 ,12 ,110 ,183 }, RegistrationDate = new DateTime(2023, 3, 10), IsBanned=false, BannedDate=null, RefreshTokens = new List<RefreshToken>() },
            new User() { Id = new Guid("ead9e0c0-395b-4489-a82b-416562905957"), Name = "4", Email = "4@4.4", RoleId = Roles[2].Id, PasswordHash = "Kfqg0txtZSqNkmeQbOosmGadf/IIaB2z3WaeMr3C1o0=", PasswordSalt = new byte[] { 205 ,233 ,1 ,141 ,87 ,98 ,77 ,54 ,135 ,152 ,169 ,87 ,148 ,116 ,188 ,201 }, RegistrationDate = new DateTime(2023, 7, 20), IsBanned=false, BannedDate=null, RefreshTokens = new List<RefreshToken>() },
            new User() { Id = new Guid("adca4721-3a4c-44ca-80a6-de74abc7450e"), Name = "5", Email = "5@5.5", RoleId = Roles[3].Id, PasswordHash = "4PDjB8dRo5n/m9N7vnYR8tM/PdyB0M7wV+dHNRAD3YQ=", PasswordSalt = new byte[] { 51 ,48 ,107 ,15 ,165 ,157 ,219 ,223 ,108 ,49 ,81 ,49 ,152 ,219 ,5 ,159 }, RegistrationDate = new DateTime(2023, 8, 2), IsBanned=false, BannedDate=null, RefreshTokens = new List<RefreshToken>() },
            new User() { Id = new Guid("f5080b8b-9b17-497b-8fe3-9470978b0ab1"), Name = "6", Email = "6@6.6", RoleId = Roles[4].Id, PasswordHash = "Pmuehs/dEiTauUtjQXqPWSjr4XombKHPuqgZBW1JYhM=", PasswordSalt = new byte[] { 128 ,183 ,146 ,79 ,41 ,2 ,134 ,246 ,132 ,144 ,191 ,89 ,214 ,199 ,85 ,70 }, RegistrationDate = new DateTime(2023, 11, 14), IsBanned=false, BannedDate=null, RefreshTokens = new List<RefreshToken>() },
        };
