        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsEmailHidden = table.Column<bool>(type: "bit", nullable: false),
                    IsRegistrationDateHidden = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "BannedDate", "Email", "IsBanned", "IsEmailHidden", "IsRegistrationDateHidden", "Name", "PasswordHash", "PasswordSalt", "RegistrationDate", "RoleId" },
                values: new object[,]
                {
                    { new Guid("2efa388c-584b-4e8d-9c5d-29fa600cfac9"), null, "3@3.3", false, true, false, "3", "mVJOzj048UABroLpqaiOCXC7ov4rY/bHqr8zYznk+2I=", new byte[] { 34, 54, 150, 248, 77, 23, 108, 37, 149, 29, 207, 94, 119, 12, 110, 183 }, new DateTime(2023, 3, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("b32f93a5-b2d9-4d59-ba83-e9a672f67dde") },
                    { new Guid("35434031-0853-472c-8c87-3b7831e0fd17"), null, "1@1.1", false, true, false, "1", "yE3UT3m6W4KlkNLJdTAM4UQYIZuS7QIU/6kWcAjU/mc=", new byte[] { 118, 75, 18, 36, 222, 48, 190, 38, 185, 49, 119, 151, 113, 34, 164, 228 }, new DateTime(2023, 4, 6, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("67f7c180-23df-4985-b243-5223c69fa797") },
                    { new Guid("adca4721-3a4c-44ca-80a6-de74abc7450e"), null, "5@5.5", false, true, false, "5", "4PDjB8dRo5n/m9N7vnYR8tM/PdyB0M7wV+dHNRAD3YQ=", new byte[] { 51, 48, 107, 15, 165, 157, 219, 223, 108, 49, 81, 49, 152, 219, 5, 159 }, new DateTime(2023, 8, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("9198cf7c-486e-4003-a176-3cde363f656a") },
                    { new Guid("ead9e0c0-395b-4489-a82b-416562905957"), null, "4@4.4", false, true, false, "4", "Kfqg0txtZSqNkmeQbOosmGadf/IIaB2z3WaeMr3C1o0=", new byte[] { 205, 233, 1, 141, 87, 98, 77, 54, 135, 152, 169, 87, 148, 116, 188, 201 }, new DateTime(2023, 7, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("5357d05f-e484-4a52-907e-3710fc71a64b") },
                    { new Guid("f5080b8b-9b17-497b-8fe3-9470978b0ab1"), null, "6@6.6", false, true, false, "6", "Pmuehs/dEiTauUtjQXqPWSjr4XombKHPuqgZBW1JYhM=", new byte[] { 128, 183, 146, 79, 41, 2, 134, 246, 132, 144, 191, 89, 214, 199, 85, 70 }, new DateTime(2023, 11, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("6009b44e-9b19-4c0c-9cb6-52d91169ad96") },
                    { new Guid("f725550b-b2b0-4509-85bd-556535471756"), null, "2@2.2", false, true, false, "2", "KjK/J9gOLsJ5Qi8MQlpn7+G5YcU1ZnQtuZI1X+TTzy0=", new byte[] { 137, 110, 127, 108, 129, 137, 155, 42, 178, 110, 230, 77, 29, 222, 131, 149 }, new DateTime(2023, 5, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("67f7c180-23df-4985-b243-5223c69fa797") }
                });
